        ...
        <div class="modal-body modalTitulo">
           ...
           <button type="button" class="close" data-dismiss="modal">&times;</button>
			...
			<hr>
				...
				<!------------------------------------------
                 POLITICAS DE PRIVACIDAD GENERADAS EN
                    LA PAGINA DE www.iuebenda.com
                ------------------------------------------>
                <div class="checkBox">
                    <label for="">
                        <input id="regPoliticas" type="checkbox">
                        <small>
                            Al registrarce usted acepta nuestras condiciones de uso y políticas de privacidad.
                            <br>
                                <a href="https://www.iubenda.com/privacy-policy/29201839" class="iubenda-white iubenda-embed" title="condiciones de uso y políticas de privacidad">Leer Más</a><script type="text/javascript">(function (w,d) {var loader = function () {var s = d.createElement("script"), tag = d.getElementsByTagName("script")[0]; s.src="https://cdn.iubenda.com/iubenda.js"; tag.parentNode.insertBefore(s,tag);}; if(w.addEventListener){w.addEventListener("load", loader, false);}else if(w.attachEvent){w.attachEvent("onload", loader);}else{w.onload = loader;}})(window, document);</script>
                        </small>
                    </label>
                </div>
