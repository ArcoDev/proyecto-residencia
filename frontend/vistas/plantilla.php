...
<head>
	...
	<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/navegacion.css">
...
======================================-->
	...
	<script src="<?php echo $url; ?>vistas/js/navegacion.js"></script>
	...
	=============================================*/
		...
		$(".btnGoogle").click(function () {
			...
			window.open(
				...
				'https://plus.google.com/share?url=<?php  echo $_SERVER['
				HTTP_HOST '].$_SERVER['
				REQUEST_URI '];  ?>',
				'',
